         ...
         @foreach($ads as $k=>$v) 
          <li style="background:#f21a2f">
              <a expotype="2" expo="index_lbgg0101:365天放心购" href="http://sale.suning.com/zh/315baofa/index.html" title="365天放心购" target="_blank" name="index2_none_lbgg_010{{$k}}">
                <img data-src="{{$v->src}}" alt="365天放心购" />
              </a>
          </li>
          @endforeach 
         </ul> 
       ...
       <div class="show-case"> 
        ...
        <div class="box-all"> 
         ...
         <div class="notice"> 
          ...
          <ul class="list">
           @foreach($res as $k=>$v)
           <li ><a name="index2_none_gg_01" href="http://sale.suning.com/zh/315baofa/index.html" rel="nofollow" target="_blank"><i>【公告】</i><em>{{$v->title}}</em></a></li>
           @endforeach
          </ul>
         </div> 
         <div class="title"> 
