      ...
      <div class="main-cont"> 
       ...
       <div class="reg-main mt0">
        ...
        <div class="reg-txtbox upwd-txtbox" style="display: none;"> 
         ...
         <input class="txt-input upwd" type="text" name="upwd" value="" tabindex="1" placeholder="请输入新密码" /> 
        </div>
        ...
        <div class="reg-code email-code" style="display:none"> 
          <div class="code-txtbox"> 
              <i class="ms-ico ms-ico-ok" id="errorIcon2" style="display:none"></i> 
              <i class="ico-code"></i> 
              <input class="txt-input " type="text" name="uemail-code" maxlength="4" placeholder="请输入验证码" /> 
              <label class="input-label"></label> 
          </div>
          <div class="code-num" style="border:none;"> 
              <button onclick="return goemails('.text-uemail')" style="width: 80%;height: 100%;border:none;float: right;" class="getcode btn-get-code">
                          获取邮件验证码
              </button>
          </div>
         </div>  
        ...
        <div class="reg-txtbox reupwd-txtbox" style="display: none;"> 
         ...
         <input class="txt-input reupwd" type="text" name="reupwd" value="" tabindex="1" placeholder="确认新密码" /> 
        </div>
