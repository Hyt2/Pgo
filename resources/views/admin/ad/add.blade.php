        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="{{ url('admin/ad') }}" method="post" enctype="multipart/form-data">
                    	{{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">背景颜色</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="bgcolor" type="text" required="">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
