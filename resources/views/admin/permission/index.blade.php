                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="simpledatatable" aria-describedby="simpledatatable_info">
                            ...
                            @foreach($res as $k=>$v)
                                <tr class="odd" align="center">
                                    ...
                                    <td >
                                        <a href="{{url('/admin/permission/'.$v->id.'/edit')}}" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 修改</a>
                                        <form action="{{url('/admin/permission/'.$v->id)}}" method="post" style='display:inline'>
                                            {{csrf_field()}}
                                            {{method_field('DELETE')}}
