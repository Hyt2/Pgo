                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="simpledatatable" aria-describedby="simpledatatable_info">
                            ...
                            @foreach($res as $k=>$v)
                                <tr class="odd" align="center">
                                    ...
                                    <td class=" ">
                                        {{cut_str($v->goods_name,13)}}
                                    </td>
                                    <td class=" ">
                                        {{--{{$v->goods_img}}--}}
                                        <img src="{{asset(GOODS_IMG).'/'.$v->goods_img}}" alt="" width="50px">
                                    ...
                                    <td class=" ">
                                        {{$v->goods_status ? '上架' : '下架'}}
                                    </td>
                                    <td class=" ">
                                        {{$v->CateModel->cate_name}}
                                    </td>
                                    <td class=" ">
                                        {{$v->TypeModel->type_name}}
                                    </td>
                                    <td class=" ">
                                        {{$v->BrandModel->brand_name}}
                                    </td>
                                    <td class=" ">
                                        {{$v->goods_weight}}
                                    </td>
                                    ...
                                    <td >
                                        {{--<a href="{{url('/admin/goods/'.$v->type_id)}}" class="label label-success"><i class="fa  fa-list"></i>库存</a>--}}
                                        <a href="{{url('/admin/goods/'.$v->id.'/edit')}}" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 修改</a>
                                        <form action="{{url('/admin/goods/'.$v->id)}}" method="post" style='display:inline'>
                                            {{csrf_field()}}
                                            {{method_field('DELETE')}}
